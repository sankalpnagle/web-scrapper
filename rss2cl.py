...
class DualLogger:
    def __init__(self):
        ...
        self.file_name = os.path.join(logs_dir, f'Google2C_{today}.log')
        ...
        try:
            ...
            cursor.execute(
                sql.SQL('''
                    ...
                    --AND "RETRY" IS NULL -- B'1'
                    AND "PUBLICATION" <> 'msn.com'
                    AND DATE("ARTICLEDATE") >= '2025-02-15'	
...
def get_original_links(num_processes=25, batch_size=50):
...
if __name__ == "__main__":
    get_original_links(num_processes=15, batch_size=25)   # Adjust num_processes and batch_size as needed
